...
def start_game():
    words_tuple = ("Giraffe", "Laptop", "Garage", "Marathon", "Medium", "Chicken", "School", "Random", "Antarctica", "Scramble", "Telephone", "Airplane", "Critical", "Microwave", "Chair", "Avalanche", "Chocolate", "Monkey", "Examine", "Tentacle", "Frequency", "Driving", "Diving", "Cooking", "Cleaning", "Entrepreneur", "Excellent", "Extreme", "Whipped Cream", "Maple Syrup", "Multiplication", "Divison", "Algebra", "Espresso", "Cappuccino", "Porridge", "Sentence", "Earthquake", "Fantastic", "Poison", "Discombobulated") 
    used_words = set()
    points = 0
    rounds = 4
    ...
    print(f"Game over! Your total points: {points}/4")
