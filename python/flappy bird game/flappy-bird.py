    ...
    def __init__(self, x, y):
        ...
        for num in range(1, 4):
            img = pygame.image.load(
                f"/home/hirram143/My-Git-Code/my-everything-repository/python/flappy bird/bird{num}.png"
            )
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        self.image = pygame.image.load(
            "/home/hirram143/My-Git-Code/my-everything-repository/python/flappy bird/pipe.png"
        )
        self.rect = self.image.get_rect()
...
while run:
    ...
    if not game_over and flying:
        # Generate new pipes at the specified frequency
